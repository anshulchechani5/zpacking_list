		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "zpackinglist",
									"targetURL": "#zpackinglist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zpackinglist-display": {
								"semanticObject": "zpackinglist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpackinglist",
									"url": sap.ui.require.toUrl("zpackinglist")
								}
							}
						}
					}
